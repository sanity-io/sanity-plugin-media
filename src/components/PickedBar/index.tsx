...
import {showConfirmDeleteAssetsPicked} from '../../modules/dialog'
import {pickClear, selectAssetsPicked} from '../../modules/assets'
...
const PickedBar: FC = () => {
  ...
  const handleDeletePicked = () => {
    dispatch(showConfirmDeleteAssetsPicked({assetsPicked}))
  }

...
const inputs = {
  ...
  inCurrentDocument: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq__default.default(_a$q || (_a$q = __template$q(["_id in $documentAssetIds"])))
    }, {
      name: "false",
      title: "False",
      value: groq__default.default(_b$g || (_b$g = __template$q(["!(_id in $documentAssetIds)"])))
    }],
    selectOnly: true,
  ...
  inUse: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq__default.default(_c$4 || (_c$4 = __template$q(["count(*[references(^._id)]) > 0"])))
    }, {
      name: "false",
      title: "False",
      value: groq__default.default(_d$2 || (_d$2 = __template$q(["count(*[references(^._id)]) == 0"])))
    }],
    title: "In use",
    type: "select",
    value: "true"
...
const constructFilter = _ref => {
  ...
  const baseFilter = groq__default.default(_a$p || (_a$p = __template$p(["\n    _type in ", ' && !(_id in path("drafts.**"))\n  '])), JSON.stringify(documentAssetTypes));
  ...
  ...(searchQuery ? [groq__default.default(_b$f || (_b$f = __template$p(["[_id, altText, assetId, description, originalFilename, title, url] match '*", "*'"])), searchQuery.trim())] : []),
  // Search facets
...
const checkTagName = (client, name) => {
  return function (source) {
    return source.pipe(operators$1.mergeMap(() => {
      return rxjs.from(client.fetch(groq__default.default(_a$o || (_a$o = __template$o(['count(*[_type == "', '" && name.current == $name])'])), TAG_DOCUMENT_NAME), {
        name
      }));
...
const checkSeasonName = (client, name) => {
  return function (source) {
    return source.pipe(operators$1.mergeMap(() => {
      return rxjs.from(client.fetch(groq__default.default(_b$e || (_b$e = __template$o(['count(*[_type == "', '" && name.current == $name])'])), SEASONS_DOCUMENT_NAME), {
        name
      }));
...
const checkCollaborationName = (client, name) => {
  return function (source) {
    return source.pipe(operators$1.mergeMap(() => {
      return rxjs.from(client.fetch(groq__default.default(_c$3 || (_c$3 = __template$o(['count(*[_type == "', '" && name.current == $name])'])), COLLABORATION_DOCUMENT_NAME), {
        name
      }));
    }), operators$1.mergeMap(existingCollaborationCount => {
...
const ASSETS_ACTIONS = {
  ...
  seasonsRemoveRequest: toolkit.createAction("actions/seasonsRemoveRequest", function prepare7(_ref8) {
    let {
      assets,
      season
    } = _ref8;
  ...
  seasonsAddRequest: toolkit.createAction("actions/seasonsAddRequest", function prepare8(_ref9) {
    let {
      assets,
      season
    } = _ref9;
  ...
  collaborationsRemoveRequest: toolkit.createAction("actions/collaborationsRemoveRequest", function prepare9(_ref10) {
    let {
      assets,
      collaboration
    } = _ref10;
  ...
  collaborationsAddRequest: toolkit.createAction("actions/collaborationsAddRequest", function prepare10(_ref11) {
    let {
      assets,
      collaboration
    } = _ref11;
...
const DIALOG_ACTIONS = {
  ...
  showCollaborationCreate: toolkit.createAction("dialog/showCollaborationCreate"),
  showMassEdit: toolkit.createAction("dialog/showMassEdit"),
  showTagEdit: toolkit.createAction("dialog/showTagEdit", function prepare(_ref12) {
    let {
      tagId
    } = _ref12;
    return {
  ...
  showCollaborationEdit: toolkit.createAction("dialog/showCollaborationEdit", function prepare2(_ref13) {
    let {
      collaborationId
    } = _ref13;
    return {
  ...
  showSeasonEdit: toolkit.createAction("dialog/showSeasonEdit", function prepare3(_ref14) {
    let {
      seasonId
    } = _ref14;
    return {
...
const tagsSlice = toolkit.createSlice({
  ...
  reducers: {
    ...
    fetchRequest: {
      ...
      prepare: () => {
        const query = groq__default.default(_a$n || (_a$n = __template$n(['\n          {\n            "items": *[\n              _type == "', '"\n              && !(_id in path("drafts.**"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name\n            } | order(name.current asc),\n          }\n        '])), TAG_DOCUMENT_NAME);
        return {
          payload: {
            query
          }
...
const tagsCreateEpic = (action$, state$, _ref15) => {
  ...
  return action$.pipe(operators$1.filter(tagsSlice.actions.createRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref16 => {
...
const tagsDeleteEpic = (action$, state$, _ref17) => {
  ...
  return action$.pipe(operators$1.filter(tagsSlice.actions.deleteRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref18 => {
    ...
    operators$1.mergeMap(() => client.observable.fetch(groq__default.default(_b$d || (_b$d = __template$n(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "media.tag" && name.current == $tagName]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
...
const tagsFetchEpic = (action$, state$, _ref19) => {
  ...
  return action$.pipe(operators$1.filter(tagsSlice.actions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref20 => {
...
const tagsUpdateEpic = (action$, state$, _ref21) => {
  ...
  return action$.pipe(operators$1.filter(tagsSlice.actions.updateRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref22 => {
...
const searchFacetTagUpdateEpic = (action$, state$) => action$.pipe(operators$1.filter(tagsActions.updateComplete.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref23 => {
...
const UPLOADS_ACTIONS = {
  uploadComplete: toolkit.createAction("uploads/uploadComplete", function prepare(_ref24) {
    let {
      asset
    } = _ref24;
    return {
    ...
    fetchRequest: {
      ...
      prepare: _ref25 => {
        let {
          ...
          queryFilter,
          selector = "",
          sort = groq__default.default(_a$m || (_a$m = __template$m(["order(_updatedAt desc)"])))
        } = _ref25;
        const pipe = sort || selector ? "|" : "";
        const query = groq__default.default(_b$c || (_b$c = __template$m(['\n          {\n            "items": *[', "] {\n              _id,\n              _type,\n              _createdAt,\n              _updatedAt,\n              altText,\n              description,\n              extension,\n              metadata {\n                dimensions,\n                exif,\n                isOpaque,\n              },\n              mimeType,\n              opt {\n                media\n              },\n              originalFilename,\n              size,\n              title,\n              products,\n              collaboration, \n              season,\n              name,\n              url\n            } ", " ", " ", ",\n          }\n        "])), queryFilter, pipe, sort, selector);
        return {
          payload: {
            params,
            query
...
const assetsDeleteEpic = (action$, _state$, _ref27) => {
  ...
  return action$.pipe(operators$1.filter(assetsActions.deleteRequest.match), operators$1.mergeMap(action => {
    ...
    return rxjs.of(assets).pipe(operators$1.mergeMap(() => client.observable.delete({
      query: groq__default.default(_c$2 || (_c$2 = __template$m(["*[_id in ", "]"])), JSON.stringify(assetIds))
...
const assetsFetchEpic = (action$, state$, _ref28) => {
  ...
  return action$.pipe(operators$1.filter(assetsActions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref29 => {
...
const assetsFetchPageIndexEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.loadPageIndex.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref30 => {
  ...
  return rxjs.of(assetsActions.fetchRequest({
    ...
    selector: groq__default.default(_d$1 || (_d$1 = __template$m(["[", "...", "]"])), start, end),
    sort: groq__default.default(_e || (_e = __template$m(["order(", " ", ")"])), (_d2 = (_c2 = state.assets) == null ? void 0 : _c2.order) == null ? void 0 : _d2.field, (_f = (_e2 = state.assets) == null ? void 0 : _e2.order) == null ? void 0 : _f.direction)
  }));
}));
const assetsFetchNextPageEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.loadNextPage.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref31 => {
  let [_action, state] = _ref31;
  return rxjs.of(assetsActions.loadPageIndex({
    pageIndex: state.assets.pageIndex + 1
  }));
}));
const assetsFetchAfterDeleteAllEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.deleteComplete.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref32 => {
...
const assetsTagsAddEpic = (action$, state$, _ref35) => {
  ...
  return action$.pipe(operators$1.filter(ASSETS_ACTIONS.tagsAddRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref36 => {
...
const assetsTagsRemoveEpic = (action$, state$, _ref37) => {
  ...
  return action$.pipe(operators$1.filter(ASSETS_ACTIONS.tagsRemoveRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref38 => {
...
const assetsUpdateEpic = (action$, state$, _ref39) => {
  ...
  return action$.pipe(operators$1.filter(assetsActions.updateRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref40 => {
...
const assetsMassUpdateEpic = (action$, state$, _ref41) => {
  ...
  return action$.pipe(operators$1.filter(assetsActions.massUpdateRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref42 => {
    let [action] = _ref42;
    const {
      assets,
      formData
    ...
    const updateObservables = assets.map(asset => {
      ...
      return rxjs.from(client.patch(asset._id).setIfMissing({
        opt: {}
      }).setIfMissing({
        "opt.media": {}
      }).set({
        ...formDataWithoutEmptyValues
      }).commit()).pipe(operators$1.mergeMap(updatedAsset => rxjs.of(assetsActions.updateComplete({
        asset: updatedAsset
      }))), operators$1.catchError(error => {
        return rxjs.of(assetsActions.updateError({
          asset,
          error: {
            message: (error == null ? void 0 : error.message) || "Internal error",
            statusCode: (error == null ? void 0 : error.statusCode) || 500
    ...
    return rxjs.merge(...updateObservables);
  }));
};
...
const seasonsSlice = toolkit.createSlice({
  name: "seasons",
  ...
  reducers: {
    ...
    fetchRequest: {
      ...
      prepare: () => {
        const query = groq__default.default(_a$k || (_a$k = __template$k(['\n          {\n            "items": *[\n              _type == "', '"\n              && !(_id in path("drafts.**"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name\n            } | order(name.current asc),\n          }\n        '])), SEASONS_DOCUMENT_NAME);
        return {
          payload: {
            query
          }
...
const seasonsFetchEpic = (action$, state$, _ref44) => {
  ...
  return action$.pipe(operators$1.filter(seasonsSlice.actions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref45 => {
    ...
    operators$1.mergeMap(result => {
      ...
      return rxjs.of(seasonsSlice.actions.fetchComplete({
        seasons: items
      }));
    }), operators$1.catchError(error => rxjs.of(seasonsSlice.actions.fetchError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      }
...
const seasonsCreateEpic = (action$, state$, _ref46) => {
  ...
  return action$.pipe(operators$1.filter(seasonsSlice.actions.createRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref47 => {
    let [action, state] = _ref47;
    const {
      name
    } = action.payload;
    return rxjs.of(action).pipe(debugThrottle(state.debug.badConnection), operators$1.mergeMap(() => client.observable.create({
      _type: SEASONS_DOCUMENT_NAME,
      name: {
        _type: "slug",
        current: name
      }
    })), operators$1.mergeMap(result => rxjs.of(seasonsSlice.actions.createComplete({
      season: result
    }))), operators$1.catchError(error => rxjs.of(seasonsSlice.actions.createError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const seasonsUpdateEpic = (action$, state$, _ref48) => {
  ...
  return action$.pipe(operators$1.filter(seasonsSlice.actions.updateSeasonItemRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref49 => {
...
const seasonsDeleteEpic = (action$, state$, _ref50) => {
  ...
  return action$.pipe(operators$1.filter(seasonActions.deleteRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref51 => {
    ...
    debugThrottle(state.debug.badConnection),
    // Fetch assets which reference this tag
    operators$1.mergeMap(() => client.observable.fetch(groq__default.default(_b$a || (_b$a = __template$k(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "season" && name.current == $seasonName]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
...
toolkit.createSelector(selectSeasonsByIds, byIds => byIds);
...
const collaborationSlice = toolkit.createSlice({
  name: "collaborations",
...
const collaborationFetchEpic = (action$, state$, _ref52) => {
  ...
  return action$.pipe(operators$1.filter(collaborationSlice.actions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref53 => {
    ...
    operators$1.mergeMap(result => {
      ...
      return rxjs.of(collaborationSlice.actions.fetchComplete({
        collaborations: items
      }));
    }), operators$1.catchError(error => rxjs.of(collaborationSlice.actions.fetchError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      }
...
const collaborationsCreateEpic = (action$, state$, _ref54) => {
  ...
  return action$.pipe(operators$1.filter(collaborationSlice.actions.createRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref55 => {
    ...
    })), operators$1.mergeMap(result => rxjs.of(collaborationSlice.actions.createComplete({
      collaboration: result
    }))), operators$1.catchError(error => rxjs.of(collaborationSlice.actions.createError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const collaborationUpdateEpic = (action$, state$, _ref56) => {
  ...
  return action$.pipe(operators$1.filter(collaborationSlice.actions.updateCollaborationItemRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref57 => {
    ...
    operators$1.mergeMap(() => rxjs.from(client.patch(collaboration._id).set({
      name: {
        _type: "slug",
        current: formData == null ? void 0 : formData.name.current
      }
    ...
    // Dispatch complete action
    operators$1.mergeMap(updatedCollaboration => {
      return rxjs.of(collaborationSlice.actions.updateComplete({
        closeDialogId,
        collaboration: updatedCollaboration
      }));
    }), operators$1.catchError(error => rxjs.of(collaborationSlice.actions.updateError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const collaborationsDeleteEpic = (action$, state$, _ref58) => {
  ...
  return action$.pipe(operators$1.filter(collaborationActions.deleteRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref59 => {
    ...
    debugThrottle(state.debug.badConnection),
    // Fetch assets which reference this tag
    operators$1.mergeMap(() => client.observable.fetch(groq__default.default(_b$9 || (_b$9 = __template$j(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "collaboration" && name.current == $collaborationName]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
    ...
    // Dispatch complete action
    operators$1.mergeMap(() => rxjs.of(collaborationSlice.actions.deleteComplete({
      collaborationId: collaborationName._id
    }))), operators$1.catchError(error => rxjs.of(collaborationSlice.actions.deleteError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const selectCollaborationById = toolkit.createSelector([selectCollaborationsByIds, (_state, collaborationId) => collaborationId], (byIds, collaborationId) => byIds[collaborationId]);
const selectCollaborations = toolkit.createSelector(selectCollaborationsByIds, byIds => Object.values(byIds));
toolkit.createSelector(selectCollaborationsByIds, byIds => byIds);
...
var _a$i;
const Container$1 = styled__default.default(ui.Box)(_ref60 => {
  let {
    scheme,
    theme
  } = _ref60;
...
var _a$h;
const StackContainer = styled__default.default(ui.Flex)(_ref67 => {
  let {
    theme
  } = _ref67;
...
const assetFormSchema = z__namespace.object({
  name: z__namespace.string().trim(),
  season: z__namespace.object({
    label: z__namespace.string().trim().min(1, {
      message: "Label cannot be empty"
    }),
    value: z__namespace.string().trim().min(1, {
  ...
  collaboration: z__namespace.object({
    label: z__namespace.string().trim().min(1, {
      message: "Label cannot be empty"
    }),
    value: z__namespace.string().trim().min(1, {
  ...
  products: z__namespace.array(z__namespace.object({
    _key: z__namespace.string(),
    id: z__namespace.string(),
    imageUrl: z__namespace.string(),
    name: z__namespace.string(),
    published: z__namespace.boolean()
  })).optional(),
...
const massEditAssetsFormSchema = z__namespace.object({
  name: z__namespace.string().trim(),
  season: z__namespace.object({
    label: z__namespace.string().trim().min(1, {
      message: "Label cannot be empty"
...
var _a$g;
const Container = styled__default.default(ui.Box)(_ref71 => {
  let {
    theme
  } = _ref71;
  var _a2, _b, _c;
...
const StyledErrorOutlineIcon = styled__default.default(ErrorOutlineIcon)(_ref76 => {
  let {
    theme
  } = _ref76;
  var _a, _b, _c, _d;
...
var _a$f, _b$8;
const Image$1 = styled__default.default.img(_b$8 || (_b$8 = __template$f(["\n  --checkerboard-color: ", ";\n\n  display: block;\n  width: 100%;\n  height: 100%;\n  object-fit: contain;\n\n  ", "\n"])), props => props.scheme ? getSchemeColor(props.scheme, "bg2") : "inherit", props => props.showCheckerboard && styled.css(_a$f || (_a$f = __template$f(["\n      background-image: linear-gradient(45deg, var(--checkerboard-color) 25%, transparent 25%),\n        linear-gradient(-45deg, var(--checkerboard-color) 25%, transparent 25%),\n        linear-gradient(45deg, transparent 75%, var(--checkerboard-color) 75%),\n        linear-gradient(-45deg, transparent 75%, var(--checkerboard-color) 75%);\n      background-size: 20px 20px;\n      background-position: 0 0, 0 10px, 10px -10px, -10px 0;\n    "]))));
...
const AutocompleteWithPayload = ui.Autocomplete;
...
function ProductSelector(props) {
  ...
  const debouncedValue = usehooksTs.useDebounce(searchValue, 700);
  react.useEffect(() => {
  ...
  const handleQueryChange = react.useCallback(searchString => {
    setSearchValue(searchString || "");
  }, [setSearchValue]);
  const products = react.useMemo(() => results.map(result => {
    var _a, _b, _c, _d;
    return {
      payload: result,
  ...
  const onSelect = react.useCallback(matcher => {
    var _a, _b, _c, _d, _e;
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Card, {
    ...
    children: [/* @__PURE__ */jsxRuntime.jsx(FormFieldInputLabel, {
      ...
      marginY: 2,
      children: /* @__PURE__ */jsxRuntime.jsx(AutocompleteWithPayload, {
        fontSize: [2, 2, 3],
        id: "product-selector",
        icon: SearchIcon,
      ...
      paddingTop: 3,
      marginBottom: 3,
      children: [localValue.length > 0 && /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
        ...
        padding: [2, 2, 3],
        text: "Clear all"
      }), localValue == null ? void 0 : localValue.map(product => /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
        marginY: 2,
        children: /* @__PURE__ */jsxRuntime.jsx(ProductPreview, {
...
const FormFieldInputCollaborations = props => {
  ...
  const scheme = sanity.useColorSchemeValue();
...
const DialogAssetEdit = props => {
  ...
  const handleCreateSeason = react.useCallback(seasonName => {
    dispatch(seasonActions.createRequest({
      name: seasonName
    }));
  }, [dispatch]);
  const handleCreateCollaboration = react.useCallback(collaborationName => {
  ...
  react.useEffect(() => {
    ...
    const subscriptionAsset = client.listen(groq__default.default(_a$e || (_a$e = __template$e(["*[_id == $id]"]))), {
            ...
            return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [/* @__PURE__ */jsxRuntime.jsxs(ui.TabList, {
                ...
                children: [!assetItem && /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                  ...
                  children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
                    space: 3,
                    children: [/* @__PURE__ */jsxRuntime.jsx(FormFieldInputText, {
                      ...register("title"),
                      disabled: formUpdating,
                    ...
                    }), /* @__PURE__ */jsxRuntime.jsx(FormFieldInputTags, {
                      control,
                      disabled: formUpdating,
                    ...
                    }), /* @__PURE__ */jsxRuntime.jsx(FormFieldInputSeasons, {
                      control,
                      disabled: formUpdating,
                    ...
                    }), /* @__PURE__ */jsxRuntime.jsx(FormFieldInputCollaborations, {
                      control,
                      disabled: formUpdating,
                    ...
                    }), /* @__PURE__ */jsxRuntime.jsx(ProductSelector, {
...
const DialogTagEdit = props => {
  ...
  react.useEffect(() => {
    ...
    const subscriptionAsset = client.listen(groq__default.default(_a$d || (_a$d = __template$d(["*[_id == $id]"]))), {
...
var _a$c, _b$7;
const TagContainer = styled__default.default(ui.Flex)(_a$c || (_a$c = __template$c(["\n  height: ", "px;\n"])), PANEL_HEIGHT);
const ButtonContainer$2 = styled__default.default(ui.Flex)(_b$7 || (_b$7 = __template$c(["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"])), TagContainer);
...
const Tag = props => {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(TagContainer, {
    ...
    }), /* @__PURE__ */jsxRuntime.jsxs(ButtonContainer$2, {
      align: "center",
      style: {
        flexShrink: 0
      },
...
const VirtualRow$3 = react.memo(_ref81 => {
  let {
    isScrolling,
    item
  } = _ref81;
...
const TagsVirtualized = () => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(reactVirtuoso.Virtuoso, {
    ...
    itemContent: index => {
      return /* @__PURE__ */jsxRuntime.jsx(VirtualRow$3, {
        isScrolling,
        item: items[index]
      });
    },
...
const DialogMassAssetEdit = props => {
  ...
  const {
    ...
    defaultValues,
    mode: "onChange",
    resolver: zod.zodResolver(massEditAssetsFormSchema)
  });
  const currentValues = getValues();
  const handleClose = react.useCallback(() => {
    dispatch(dialogActions.remove({
...
const DialogSeasonEdit = props => {
  ...
  const [seasonSnapshot, setSeasonSnapshot] = react.useState(seasonItem == null ? void 0 : seasonItem.season);
  ...
  react.useEffect(() => {
    ...
    const subscriptionAsset = client.listen(groq__default.default(_a$b || (_a$b = __template$b(["*[_id == $id]"]))), {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(Dialog, {
    ...
    children: [/* @__PURE__ */jsxRuntime.jsxs(ui.Box, {
      ...
      padding: 4,
      onSubmit: handleSubmit(onSubmit),
      children: [!seasonItem && /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
        marginBottom: 3,
        padding: 3,
        radius: 2,
        shadow: 1,
...
const DialogCollaborationEdit = props => {
  ...
  const [collaborationSnapshot, setCollaborationSnapshot] = react.useState(collaborationItem == null ? void 0 : collaborationItem.collaboration);
  ...
  const handleCollaborationUpdate = react.useCallback(update => {
    var _a3;
    const {
      result,
      transition
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(Dialog, {
    ...
    children: [/* @__PURE__ */jsxRuntime.jsxs(ui.Box, {
      ...
      padding: 4,
      onSubmit: handleSubmit(onSubmit),
      children: [!collaborationItem && /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
        marginBottom: 3,
        padding: 3,
        radius: 2,
        shadow: 1,
...
const Dialogs = () => {
  ...
  const renderDialogs = (dialogs, index) => {
    ...
    if (dialog.type === "massEdit") {
      return /* @__PURE__ */jsxRuntime.jsx(DialogMassAssetEdit, {
        dialog,
        children: childDialogs
      }, index);
    }
    ...
    if (dialog.type === "seasonEdit") {
      return /* @__PURE__ */jsxRuntime.jsx(DialogSeasonEdit, {
        dialog,
        children: childDialogs
      }, index);
    }
    if (dialog.type === "collaborationEdit") {
      return /* @__PURE__ */jsxRuntime.jsx(DialogCollaborationEdit, {
        dialog,
        children: childDialogs
      }, index);
    }
...
const CardWrapper$1 = styled__default.default(ui.Flex)(_a$9 || (_a$9 = __template$9(["\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n  width: 100%;\n"])));
const CardContainer = styled__default.default(ui.Flex)(_ref83 => {
  let {
    picked,
    theme,
    updating
  ...
  var _a2, _b2, _c2, _d2;
  return styled.css(_c$1 || (_c$1 = __template$9(["\n      border: 1px solid transparent;\n      height: 100%;\n      pointer-events: ", ";\n      position: relative;\n      transition: all 300ms;\n      user-select: none;\n      width: 100%;\n\n      border: ", ";\n\n      ", "\n    "])), updating ? "none" : "auto", picked ? "1px solid ".concat((_d2 = (_c2 = (_b2 = (_a2 = theme == null ? void 0 : theme.sanity) == null ? void 0 : _a2.color) == null ? void 0 : _b2.spot) == null ? void 0 : _c2.orange) != null ? _d2 : "orange", " !important") : "1px solid inherit", !updating && styled.css(_b$6 || (_b$6 = __template$9(["\n        @media (hover: hover) and (pointer: fine) {\n          &:hover {\n            border: 1px solid var(--card-border-color);\n          }\n        }\n      "]))));
});
const ContextActionContainer$2 = styled__default.default(ui.Flex)(_ref84 => {
  let {
    scheme
  } = _ref84;
  return styled.css(_d || (_d = __template$9(["\n    cursor: pointer;\n    height: ", "px;\n    transition: all 300ms;\n    @media (hover: hover) and (pointer: fine) {\n      &:hover {\n        background: ", ";\n      }\n    }\n  "])), PANEL_HEIGHT, getSchemeColor(scheme, "bg"));
});
const StyledWarningOutlineIcon = styled__default.default(WarningFilledIcon)(_ref85 => {
  let {
    theme
  } = _ref85;
  return {
...
const uploadsAssetUploadEpic = (action$, state$) => action$.pipe(operators$1.filter(uploadsActions.uploadRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref87 => {
...
const uploadsCheckRequestEpic = (action$, state$, _ref88) => {
  ...
  return action$.pipe(operators$1.filter(uploadsActions.checkRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref89 => {
    ...
    const query = groq__default.default(_a$8 || (_a$8 = __template$8(["\n        *[", " && _id in $documentIds].sha1hash\n      "])), constructedFilter);
...
var _a$7;
const CardWrapper = styled__default.default(ui.Flex)(_a$7 || (_a$7 = __template$7(["\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n  width: 100%;\n"])));
...
const VirtualCell = react.memo(_ref90 => {
  let {
    item,
    selected
  } = _ref90;
...
const ItemContainer = styled__default.default.div(_a$6 || (_a$6 = __template$6(["\n  height: ", "px;\n  width: ", "px;\n"])), CARD_HEIGHT, CARD_WIDTH);
const ListContainer = styled__default.default.div(_b$5 || (_b$5 = __template$6(["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, ", "px);\n  grid-template-rows: repeat(auto-fill, ", "px);\n  justify-content: center;\n  margin: 0 auto;\n"])), CARD_WIDTH, CARD_HEIGHT);
...
var _a$5;
const ContextActionContainer$1 = styled__default.default(ui.Flex)(_ref91 => {
  let {
    scheme
  } = _ref91;
...
const ContainerGrid = styled__default.default(ui.Grid)(_ref92 => {
  let {
    scheme,
    selected,
    updating
  } = _ref92;
  return styled.css(_b$4 || (_b$4 = __template$4(["\n      align-items: center;\n      cursor: ", ";\n      height: 100%;\n      pointer-events: ", ";\n      user-select: none;\n      white-space: nowrap;\n\n      ", "\n    "])), selected ? "default" : "pointer", updating ? "none" : "auto", !updating && styled.css(_a$4 || (_a$4 = __template$4(["\n        @media (hover: hover) and (pointer: fine) {\n          &:hover {\n            background: ", ";\n          }\n        }\n      "])), getSchemeColor(scheme, "bg")));
});
const ContextActionContainer = styled__default.default(ui.Flex)(_ref93 => {
  let {
    scheme
  } = _ref93;
  return styled.css(_c || (_c = __template$4(["\n    cursor: pointer;\n    @media (hover: hover) and (pointer: fine) {\n      &:hover {\n        background: ", ";\n      }\n    }\n  "])), getSchemeColor(scheme, "bg2"));
});
const StyledWarningIcon = styled__default.default(WarningFilledIcon)(_ref94 => {
  let {
    theme
  } = _ref94;
  return {
...
const VirtualRow$2 = react.memo(_ref96 => {
  let {
    item,
    selected
  } = _ref96;
...
const AssetTableVirtualized = props => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(reactVirtuoso.GroupedVirtuoso, {
    ...
    itemContent: index => {
      const item = items[index];
      const selected = selectedIds.includes(item == null ? void 0 : item.id);
      return /* @__PURE__ */jsxRuntime.jsx(VirtualRow$2, {
        item,
        selected
      });
    },
...
var _a$3, _b$3;
const UploadContainer = styled__default.default.div(_a$3 || (_a$3 = __template$3(["\n  color: white;\n  height: 100%;\n  min-height: 100%;\n  right: 0;\n  top: 0;\n  width: 100%;\n\n  &:focus {\n    outline: none;\n  }\n"])));
const DragActiveContainer = styled__default.default.div(_b$3 || (_b$3 = __template$3(["\n  align-items: center;\n  background: rgba(0, 0, 0, 0.75);\n  display: flex;\n  height: 100%;\n  justify-content: center;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 100%;\n  z-index: 3;\n"])));
...
var _a$2, _b$2;
const SeasonContainer$1 = styled__default.default(ui.Flex)(_a$2 || (_a$2 = __template$2(["\n  height: ", "px;\n"])), PANEL_HEIGHT);
const ButtonContainer$1 = styled__default.default(ui.Flex)(_b$2 || (_b$2 = __template$2(["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"])), SeasonContainer$1);
...
const Season$1 = props => {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(SeasonContainer$1, {
    align: "center",
    flex: 1,
    justify: "space-between",
    paddingLeft: 3,
    ...
    }), /* @__PURE__ */jsxRuntime.jsxs(ButtonContainer$1, {
      align: "center",
      style: {
        flexShrink: 0
      },
      children: [(actions == null ? void 0 : actions.includes("search")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton$1, {
        disabled: season == null ? void 0 : season.updating,
        icon: isSearchFacetTag ? /* @__PURE__ */jsxRuntime.jsx(CloseIcon, {}) : /* @__PURE__ */jsxRuntime.jsx(SearchIcon, {}),
        onClick: isSearchFacetTag ? handleSearchFacetTagRemove : handleSearchFacetTagAddOrUpdate,
        tooltip: isSearchFacetTag ? "Remove filter" : "Filter by tag"
      }), (actions == null ? void 0 : actions.includes("edit")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton$1, {
        disabled: season == null ? void 0 : season.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(EditIcon, {}),
        onClick: handleShowSeasonEditDialog,
        tone: "primary",
        tooltip: "Edit Season"
      }), (actions == null ? void 0 : actions.includes("applyAll")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton$1, {
        disabled: season == null ? void 0 : season.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(ArrowUpIcon, {}),
        onClick: handleShowAddSeasonToAssetsDialog,
        tone: "primary",
        tooltip: "Add Season to selected assets"
      }), (actions == null ? void 0 : actions.includes("removeAll")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton$1, {
        disabled: season == null ? void 0 : season.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(ArrowDownIcon, {}),
        onClick: handleShowRemoveSeasonFromAssetsDialog,
        tone: "critical",
        tooltip: "Remove Season from selected assets"
      }), (actions == null ? void 0 : actions.includes("delete")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton$1, {
        disabled: season == null ? void 0 : season.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(TrashIcon, {}),
...
const VirtualRow$1 = react.memo(_ref97 => {
  let {
    isScrolling,
    item
  } = _ref97;
  ...
  return /* @__PURE__ */jsxRuntime.jsx(Season$1, {
    actions: isScrolling ? void 0 : item.actions,
    season: item
...
const SeasonView = () => {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
    ...
    }), hasTags && /* @__PURE__ */jsxRuntime.jsx(SeasonsVirtualized, {})]
  });
};
const SeasonsPanel = () => {
  const seasonsPanelVisible = useTypedSelector(state => state.seasons.panelVisible);
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(SeasonView, {})
    })
  });
};
...
var _a$1, _b$1;
const SeasonContainer = styled__default.default(ui.Flex)(_a$1 || (_a$1 = __template$1(["\n  height: ", "px;\n"])), PANEL_HEIGHT);
const ButtonContainer = styled__default.default(ui.Flex)(_b$1 || (_b$1 = __template$1(["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"])), SeasonContainer);
...
const Season = props => {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(SeasonContainer, {
    align: "center",
    flex: 1,
    justify: "space-between",
    paddingLeft: 3,
    children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
      ...
      children: [(actions == null ? void 0 : actions.includes("search")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton, {
        disabled: collaboration == null ? void 0 : collaboration.updating,
        icon: isSearchFacetTag ? /* @__PURE__ */jsxRuntime.jsx(CloseIcon, {}) : /* @__PURE__ */jsxRuntime.jsx(SearchIcon, {}),
        onClick: isSearchFacetTag ? handleSearchFacetTagRemove : handleSearchFacetTagAddOrUpdate,
        tooltip: isSearchFacetTag ? "Remove filter" : "Filter by tag"
      }), (actions == null ? void 0 : actions.includes("edit")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton, {
        disabled: collaboration == null ? void 0 : collaboration.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(EditIcon, {}),
        onClick: handleShowSeasonEditDialog,
        tone: "primary",
        tooltip: "Edit Season"
      }), (actions == null ? void 0 : actions.includes("applyAll")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton, {
        disabled: collaboration == null ? void 0 : collaboration.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(ArrowUpIcon, {}),
        onClick: handleShowAddSeasonToAssetsDialog,
        tone: "primary",
        tooltip: "Add Season to selected assets"
      }), (actions == null ? void 0 : actions.includes("removeAll")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton, {
        disabled: collaboration == null ? void 0 : collaboration.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(ArrowDownIcon, {}),
        onClick: handleShowRemoveSeasonFromAssetsDialog,
        tone: "critical",
        tooltip: "Remove Season from selected assets"
      }), (actions == null ? void 0 : actions.includes("delete")) && /* @__PURE__ */jsxRuntime.jsx(SeasonButton, {
        disabled: collaboration == null ? void 0 : collaboration.updating,
        icon: /* @__PURE__ */jsxRuntime.jsx(TrashIcon, {}),
        onClick: handleShowSeasonDeleteDialog,
        tone: "critical",
...
const VirtualRow = react.memo(_ref99 => {
  let {
    isScrolling,
    item
  } = _ref99;
  ...
  return /* @__PURE__ */jsxRuntime.jsx(Season, {
    actions: isScrolling ? void 0 : item.actions,
    collaboration: item
...
const CollaborationView = () => {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
    ...
    }), fetchComplete && !hasCollaborations && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
      padding: 3,
      children: /* @__PURE__ */jsxRuntime.jsx(ui.Text, {
        muted: true,
        size: 1,
    ...
    }), hasCollaborations && /* @__PURE__ */jsxRuntime.jsx(CollaborationsVirtualized, {})]
  });
};
const CollaborationsPanel = () => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(CollaborationView, {})
    })
  });
};
      ...
      children: [/* @__PURE__ */jsxRuntime.jsx(Dialogs, {}), /* @__PURE__ */jsxRuntime.jsx(Notifications, {}), /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(Header, {
            ...
            }), /* @__PURE__ */jsxRuntime.jsx(SeasonsPanel, {}), /* @__PURE__ */jsxRuntime.jsx(CollaborationsPanel, {})]
